...
def main(args):
    ...
    pbar = tqdm(range(1, args.total_iters + 1), disable=args.no_tqdm, dynamic_ncols=True, desc="sde_grpo")
    for step in pbar:
        b = args.batch_size
        g = args.G
        bg = b * g
...
if __name__ == "__main__":
    ...
    parser.add_argument("--results-dir", type=str, default="results/sde_grpo")
